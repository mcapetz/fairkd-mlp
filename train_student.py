...
#     out_np = out.detach().cpu().numpy()
    ...
    if args.dataset == "sbm":
        ...
        np.save(f'saved_arrays/trad_metrics_student_{args.seed}_{args.dataset}.npy', trad_metrics, allow_pickle=True)
    ...
    if args.dataset == "sbm":
        ...
        np.save(f'saved_arrays/overall_cm_student_{args.seed}_{args.dataset}.npy', overall_cm, allow_pickle=True)
        np.save(f'saved_arrays/group_0_cm_student_{args.seed}_{args.dataset}.npy', group_0_cm, allow_pickle=True)
        np.save(f'saved_arrays/group_1_cm_student_{args.seed}_{args.dataset}.npy', group_1_cm, allow_pickle=True)
    ...
    if args.dataset == "sbm":
        ...
        np.save(f'saved_arrays/auc_ovr_diff_student_{args.seed}_{args.dataset}.npy', macro_roc_auc_ovr_diff, allow_pickle=True)
        np.save(f'saved_arrays/auc_ovr_overall_student_{args.seed}_{args.dataset}.npy', macro_roc_auc_ovr, allow_pickle=True)
    ...
    if args.dataset == "sbm":
        ...
        np.save(f'saved_arrays/acc_student_{args.seed}_{args.dataset}.npy', float(score_str), allow_pickle=True)
